...
HD_PWD='D:/UOM/2nd Semester/Computer organization and Digital Design/NanoProcessor_3bit_Counter_Added/NanoProcessor_3bit_Counter_Added.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder_3_Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder_3_Bit.tcl
